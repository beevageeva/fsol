...
$\frac{F_c}{F_g} \approx \frac{F_Prad}{F_g}  \approx 0$
...
Hay que considerar para cado estado de ionización un término en la suma con abundancia $p_{j_i} \cdot X_j $ donde $p_{j_i}$ es la proporcion de estos iones de todos los átomos de este elemento ($A_j$ va a ser el mismo, pero $N_j$ va a ser diferente para cada estado de ionización)
