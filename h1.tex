...
Para los elementos completamente ionizados(todos los electrones libres) $\mu_j = \frac{A_j}{1+Z_j}$ donde $Z_j$ = núm protones del núcleo(núm atómico) y en este caso para los metales $\mu_j \approx 2$
