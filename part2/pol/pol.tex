...
(Rayleigh scattering) 
\item shorter wavelengths more scattered (blue sky)
\item in the Sun: Thomson scattering by electrons and Rayleigh scattering by neutral H 
\end{itemize}
\end{frame}
...
\begin{frame}{Geometric representation}
Unpolarized incident light and magnetic field along l.o.s 
\tdplotsetmaincoords{60}{120} 
\begin{tikzpicture} [scale=2, tdplot_main_coords, 
axis/.style={->, thick},
osc/.style={ blue, very thick   },
...
\draw[->, very thick] (0.5,3.5,0) -- (2,3.5,0);
\node at (2,3.5,0)[anchor=north]{$\vec{B}$};
\draw[vector] (y21) -- (y22);
\draw[vector] (y31) -- (y32);
