...
$ <{\delta_r}^2> =  \frac{int(r) 8^6 <{\delta_8}^2> }{int(8) r^6} = 2898958.58 \cdot \frac{int(r)}{r^6} $

$ <{\delta_{10}}^2> =   2898958.58 \cdot \frac{0.0782653}{10^6} = 0.227$

$ <{\delta_{30}}^2> =   2898958.58 \cdot \frac{0.8356}{30^6} = 0.0033 $
